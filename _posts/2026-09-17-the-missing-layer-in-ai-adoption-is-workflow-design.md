...
1. Someone agrees that the problem matters.
2. They try the workflow on a real task.
3. They return to it without direct support.
4. Another person can use or adapt it.
5. The workflow becomes part of recurring work.
6. A manual step is reduced or eliminated.
